...
Static files (`lib`) can contain either `static libraries` (containing object files) or `import libraries` (containing symbols to allow the linker to link to a `dll`).
